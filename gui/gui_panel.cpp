...
class GuiSplitPanel : public IGuiSplitPanel, public IWidgetInternal {
public:
    ...
    void mark_dirty() override {
        dirty_ = true;
        if (auto* pi = internal_of(parent_)) pi->mark_dirty();
    }
...
class GuiDockPanel : public IGuiDockPanel, public IWidgetInternal {
public:
    GuiDockPanel()
