/*
 * wheel_evdev.cpp - Linux evdev steering wheel implementation (stub)
 *
 * TODO: Implement proper steering wheel support via evdev.
...
void WheelManager::update() {
    // TODO: Poll evdev devices for racing wheel input
}
