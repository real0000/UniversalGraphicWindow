/*
 * wheel_android.cpp - Android steering wheel implementation (stub)
 *
 * TODO: Implement proper steering wheel support via Android InputDevice.
...
void WheelManager::update() {
    // TODO: Poll Android InputDevice for racing wheel input
}
